  ...
  return (
    <div className="min-h-screen" style={{fontFamily:"Playful Display"}}>
      <div className="mt-[50px]">
        <LandingComponent image="https://images.unsplash.com/photo-1709055022660-46f701fe6be2?q=80&w=1339&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" title="Care Pathway" subtitle="The HWS client journey is structured as a progression from an initial conversation to a process of ongoing development.
        ...
        <motion.div
          ...
          className=" flex items-center flex-col text-left my-16 px-5 md:px-24"
        >
          <p className=" max-w-4xl text-[#3f2a1d] text-lg mb-5 ">
          ...
          <p className=" max-w-4xl text-[#3f2a1d] text-lg  ">
        ...
        {/* Footer */}
        <p className="mt-12 px-5 pb-10 md:px-0 md:mx-auto md:max-w-4xl text-left text-lg text-[#3f2a1d]">
